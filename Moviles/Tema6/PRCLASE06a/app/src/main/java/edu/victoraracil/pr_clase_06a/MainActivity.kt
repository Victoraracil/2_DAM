...
class MainActivity : ComponentActivity() {
                    ...
                    TopAppBar(
                        ...
                        actions = {
                            ...
                            DropdownMenu(
                                ...
                                DropdownMenuItem(
                                    text = { Text("Borrar todos los coches") },
                                    onClick = {
                            ...
                            Column(modifier = Modifier.padding(12.dp)) {
                                ...
                                Row(
                                    ...
                                    IconButton(
                                        ...
                                        Icon(
                                            imageVector = if (item.car.favorite == 1)
    ...
    private fun probarRoom() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            // Coches
            dao.insertCar(Car(model = "Corolla", motor = "Hybrid", year = 2022, idBrand = 1, favorite = 0))
            dao.insertCar(Car(model = "Focus", motor = "Diesel", year = 2020, idBrand = 2, favorite = 0))
